...
function knitwit(arg0, arg1, arg2, arg3, arg4) {
  var vec1 = arg0;
  ...
  var vec3 = arg1;
  var len3 = vec3.length;
  var result3 = realloc1(0, 0, 4, len3 * 8);
  for (let i = 0; i < vec3.length; i++) {
    const e = vec3[i];
    const base = result3 + i * 8;var ptr2 = utf8Encode(e, realloc1, memory0);
    var len2 = utf8EncodedLen;
  ...
  if (variant9 === null || variant9=== undefined) {
    ...
    const e = variant9;
    var ptr8 = utf8Encode(e, realloc1, memory0);
    var len8 = utf8EncodedLen;
    variant9_0 = 1;
    variant9_1 = ptr8;
    variant9_2 = len8;
  }
  const ret = exports1.knitwit(result1, len1, result3, len3, variant5_0, variant5_1, variant5_2, variant7_0, variant7_1, variant7_2, variant9_0, variant9_1, variant9_2);
  let variant14;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      ...
      for (let i = 0; i < len12; i++) {
        ...
        var ptr11 = dataView(memory0).getInt32(base + 8, true);
        var len11 = dataView(memory0).getInt32(base + 12, true);
    ...
    case 1: {
      var ptr13 = dataView(memory0).getInt32(ret + 4, true);
...
const $init = (() => {
  let gen = (function* init () {
    const module0 = fetchCompile(new URL('./knitwit.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./knitwit.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ...
    postReturn0 = exports1.cabi_post_knitwit;
  })();
